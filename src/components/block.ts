 ...
 * @property holder - Div element that wraps block content with Tool's content. Has `sk-block` CSS class
...
export default class Block {
  ...
  static get CSS() {
    return {
      wrapper: 'sk-block',
      wrapperStretched: 'sk-block--stretched',
      content: 'sk-block__content',
      focused: 'sk-block--focused',
      selected: 'sk-block--selected',
      dropTarget: 'sk-block--drop-target',
    };
  }
