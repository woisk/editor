...
export default class LinkInlineTool implements InlineTool {
  ...
  private readonly CSS = {
    ...
    buttonModifier: 'sk-inline-tool--link',
    buttonUnlink: 'sk-inline-tool--unlink',
    input: 'sk-inline-tool-input',
    inputShowed: 'sk-inline-tool-input--showed',
  };
  ...
  public render(): HTMLElement {
    ...
    this.nodes.button.appendChild($.svg('link', 18, 18));
    this.nodes.button.appendChild($.svg('unlink', 18, 18));
  ...
  public renderActions(): HTMLElement {
    ...
    this.nodes.input.placeholder = 'url link.';
