 ...
 * @property {Element} nodes.wrapper  - <sk-editor>
 * @property {Element} nodes.redactor - <sk-redactor>
 */
export default class UI extends Module {
  ...
  public get CSS(): {
    ...
    return {
      editorWrapper: 'sk-editor',
      editorWrapperNarrow: 'sk-editor--narrow',
      editorZone: 'sk-editor__redactor',
      editorZoneHidden: 'sk-editor__redactor--hidden',
      editorLoader: 'sk-editor__loader',
      editorEmpty: 'sk-editor--empty',
    };
  }
  ...
  public closeAllToolbars(): void {
    // const { Toolbox, BlockSettings, InlineToolbar, ConversionToolbar } = this.Editor;
    const {BlockSettings, InlineToolbar, ConversionToolbar} = this.Editor;
  ...
  private async make(): Promise<void> {
    ...
    /**
     * Create and save Toolbox UI elements
     */
