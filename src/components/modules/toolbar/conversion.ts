...
export default class ConversionToolbar extends Module {
  ...
  public static get CSS(): { [key: string]: string } {
    return {
      conversionToolbarWrapper: 'sk-conversion-toolbar',
      conversionToolbarShowed: 'sk-conversion-toolbar--showed',
      conversionToolbarTools: 'sk-conversion-toolbar__tools',
      conversionToolbarLabel: 'sk-conversion-toolbar__label',
      conversionTool: 'sk-conversion-tool',
      conversionToolHidden: 'sk-conversion-tool--hidden',
      conversionToolIcon: 'sk-conversion-tool__icon',

      conversionToolFocused: 'sk-conversion-tool--focused',
      conversionToolActive: 'sk-conversion-tool--active',
    };
  }
