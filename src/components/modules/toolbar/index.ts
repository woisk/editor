...
export default class Toolbar extends Module {
  ...
  public get CSS() {
    return {
      toolbar: 'sk-toolbar',
      content: 'sk-toolbar__content',
      actions: 'sk-toolbar__actions',
      actionsOpened: 'sk-toolbar__actions--opened',

      toolbarOpened: 'sk-toolbar--opened',

      // Content Zone
      plusButton: 'sk-toolbar__plus',
      plusButtonShortcut: 'sk-toolbar__plus-shortcut',
      plusButtonHidden: 'sk-toolbar__plus--hidden',

      // Actions Zone
      blockActionsButtons: 'sk-toolbar__actions-buttons',
      settingsToggler: 'sk-toolbar__settings-btn',
    };
  }
  ...
  public make(): void {
    ...
    this.Editor.Tooltip.onHover(this.nodes.settingsToggler, '块级选项', {
      placement: 'top',
    });
