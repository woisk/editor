...
export default class BlockSettings extends Module {
  ...
  public get CSS() {
    return {
      // Settings Panel
      wrapper: 'sk-settings',
      wrapperOpened: 'sk-settings--opened',
      toolSettings: 'sk-settings__plugin-zone',
      defaultSettings: 'sk-settings__default-zone',

      button: 'sk-settings__button',

      focusedButton : 'sk-settings__button--focused',
      focusedButtonAnimated: 'sk-settings__button--focused-animated',
    };
  }
