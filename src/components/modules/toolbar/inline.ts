...
export default class InlineToolbar extends Module {
   ...
   */
  public CSS = {
    inlineToolbar: 'sk-inline-toolbar',
    inlineToolbarShowed: 'sk-inline-toolbar--showed',
    inlineToolbarLeftOriented: 'sk-inline-toolbar--left-oriented',
    inlineToolbarRightOriented: 'sk-inline-toolbar--right-oriented',
    inlineToolbarShortcut: 'sk-inline-toolbar__shortcut',
    buttonsWrapper: 'sk-inline-toolbar__buttons',
    actionsWrapper: 'sk-inline-toolbar__actions',
    inlineToolButton: 'sk-inline-tool',
    inlineToolButtonLast: 'sk-inline-tool--last',
    inputField: 'cdx-input',
    focusedButton: 'sk-inline-tool--focused',
    conversionToggler: 'sk-inline-toolbar__dropdown',
    conversionTogglerHidden: 'sk-inline-toolbar__dropdown--hidden',
    conversionTogglerContent: 'sk-inline-toolbar__dropdown-content',
  };
  ...
  private addConversionToggler(): void {
    ...
    this.Editor.Tooltip.onHover(this.nodes.conversionToggler, '块级转换', {
      placement: 'top',
      hidingDelay: 100,
    });
  }
