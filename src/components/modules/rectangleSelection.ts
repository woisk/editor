...
export default class RectangleSelection extends Module {
  ...
  static get CSS() {
    return {
      overlay: 'sk-editor-overlay',
      overlayContainer: 'sk-editor-overlay__container',
      rect: 'sk-editor-overlay__rectangle',
      topScrollZone: 'sk-editor-overlay__scroll-zone--top',
      bottomScrollZone: 'sk-editor-overlay__scroll-zone--bottom',
    };
  }
